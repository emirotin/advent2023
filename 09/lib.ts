export const getVal = (ns: number[]) => {
	...
	// i is index, g is generation of derivatives, where 0 is the original sequence
	// when last derivative is 0, apparently all of them are 0 (I don't think this is universal)
